...
(() => {
  ...
  const STRINGS = {
    en: {
      ...
      // persony
      personasSection: "Career personas — pick which one is active; it drives Coverage and 📖 My Career",
      languagesOnly: "Languages — global, independent of your career personas",
      ...
      phPersonaLabel: "e.g. Data analyst, or Agri-data",
      maxPersonasReached: "Persona limit reached (4).",
      noPersonas: "Add your first career persona to start tracking coverage.",
      addPersona: "Add persona",
      personaSaved: "Persona saved",
      personaActivated: "Switched persona",
      confirmRemovePersona: "Remove this persona? Its lessons stay in history.",
      realProfile: "your profile",
    ...
    pl: {
      ...
      // persony
      personasSection: "Persony kariery — wybierz aktywną; steruje zakładką Pokrycie i 📖 My Career",
      languagesOnly: "Języki — globalne, niezależne od person kariery",
      newPersona: "Nowa persona",
      activeBadge: "aktywna",
      savePersona: "Zapisz personę",
      saveLanguages: "Zapisz języki",
      removePersona: "Usuń",
      personaLabel: "Nazwa persony",
      phPersonaLabel: "np. Analityk danych, albo Rolnictwo-dane",
      maxPersonasReached: "Osiągnięto limit person (4).",
      noPersonas: "Dodaj pierwszą personę kariery, żeby śledzić pokrycie.",
      addPersona: "Dodaj personę",
      personaSaved: "Persona zapisana",
      personaActivated: "Przełączono personę",
      confirmRemovePersona: "Usunąć tę personę? Jej lekcje zostają w historii.",
      realProfile: "Twój profil",
      virtualProfile: "wirtualna",
