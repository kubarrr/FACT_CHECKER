...
(() => {
  ...
  const STRINGS = {
    en: {
      ...
      corePctHint: "% = how core the skill is to this occupation — higher means required by fewer other jobs.",
    ...
    pl: {
      ...
      corePctHint: "% = jak rdzenna jest umiejętność dla tego zawodu — wyżej znaczy wymagana przez mniej innych.",
